...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative py-20 bg-white/60 text-[#556B2F] overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-heading text-[#556B2F] mb-4">
            Get In Touch
          </h2>
          <p className="text-[#556B2F]/80 max-w-2xl mx-auto">
            We’d love to hear from you. Whether you’re planning a stay, a
            celebration, or just curious — send us a message and we’ll get back
            to you shortly.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#556B2F]/80">
                  Orion Neststay Resort, Wayanad, Kerala
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.form
            ...
            className="bg-white/70 rounded-2xl shadow-xl p-8 space-y-6 border border-[#556B2F]/20 backdrop-blur-sm"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
          >
            <div>
              <label className="block text-[#556B2F] font-medium mb-2">
                Name
              </label>
              <input
                type="text"
            ...
            >
              <Send size={18} /> {submitted ? "Sent!" : "Send Message"}
            </motion.button>
          </motion.form>
        </div>
      </div>
